...
const HeaderAndHeroShot = () => {
  return (
    <div>
      ...
      <div className='w-full bg-header-and-hero-shot text-white bg-no-repeat bg-blue h-[64vh] bg-cover'>
        <div className='bg-dark-blue bg-opacity-80 p-4 gap-1 justify-center h-full text-center flex flex-col items-center'>
          ...
          <p className='text-xl md:text-sm'>I'll help you to make it happen.</p>
